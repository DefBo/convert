...
// To show/hide an action menu --- start

function findElement(array, compareElement) {
  var elementId = 0

  $(array).each(function(index, element) {
    if ($(element).is($(compareElement))) {
      elementId = index
    }
  })
...
$(document).ready(function() { 
  ...
  $(document).on('click', '.aside-card__section-item', function() {
    event.preventDefault()
  })
  
  $(document).on('click', 'ui#sortable', function() {
    if (!$(event.target).hasClass('.content-editor__section--text')) {
      $(this).removeClass('focused')
      $text = $(this).children('textarea').val()
      $(this).children('textarea').replaceWith('<span></span>')
      $(this).children('span').text($text)
    }
  })
  
  $(document).on('click', '.content-editor__section--text', function() {
    
    // console.log(this.contains(event.target))
    if (!$(this).hasClass('focused')) {
      $(this).addClass('focused')
      $text = $(this).children('span').text()
      $(this).children('span').replaceWith('<textarea></textarea>')
      $(this).children('textarea').val($text).attr('rows', 1)
    }
  })
  
  $(document).on('mouseenter', '.aside-card__section-item', function() {
    $elementId = findElement($('.aside-card__section-item'), $(this))
    $element = $('.content-editor__section')[$elementId]
    $($element).addClass('bordered')
  })
  
  $(document).on('mouseleave', '.aside-card__section-item', function() {
    $elementId = findElement($('.aside-card__section-item'), $(this))
    $element = $('.content-editor__section')[$elementId]
    $($element).removeClass('bordered')
  })
  
  $(document).on('focus', '.aside-card__section-item', function() {
    $elementId = findElement($('.aside-card__section-item'), $(this))
    $element = $('.content-editor__section')[$elementId]
    $($element).addClass('focused')
  
    if ($($element).hasClass('content-editor__section--text')) {
      $text = $($element).children('span').text()
      $($element).children('span').replaceWith('<textarea></textarea>')
      $($element).children('textarea').val($text).attr('rows', 1)
    }
  })
  
  $(document).on('blur', '.aside-card__section-item', function() {
    $elementId = findElement($('.aside-card__section-item'), $(this))
    $element = $('.content-editor__section')[$elementId]
    $($element).removeClass('focused')
  
    if ($($element).hasClass('content-editor__section--text')) {
      $text = $($element).children('textarea').val()
      $($element).children('textarea').replaceWith('<span></span>')
      $($element).children('span').text($text)
    }
  })
  
  $(document).on('click', '.lock-button', function() {
    $elementId = $(this).parent().parent().hasClass('aside-card__section-item') ? findElement($('.aside-card__section-item'), $(this).parent().parent()) : findElement('.content-editor__section', $(this).parent().parent())
    $element = $('.content-editor__section')[$elementId]
  ...
  $(document).on('click', '.delete-button', function() {
    $elementId = $(this).parent().parent().hasClass('aside-card__section-item') ? findElement($('.aside-card__section-item'), $(this).parent().parent()) : findElement('.content-editor__section', $(this).parent().parent())
    $element = $('.content-editor__section')[$elementId]
    $menuElement = $('.aside-card__section-item')[$elementId]
  ...
  $(document).on('click', '.new-sections-buttons .control-buttons .text-button', function() {
    $order = $('.content-editor__section').length + 1
    $number = $order > 9 ? $order.toString() : '0' + $order.toString()
    $li = $('<li>', { class: 'content-editor__section content-editor__section--text' })
    $header = $('<h4>', { class: 'content-editor__section-title' })
    $sectionNumber = $('<span>', { class: 'content-editor__section-number', text: $number })
    $header.text('Text section')
    $header.prepend($sectionNumber)
    $dragButton = $('<div>', { class: 'content-editor__dragdrop-btn' })
    $dragButtonImage = $('<img />', { src: 'img/dragdrop.svg', alt: 'DragDropBtn' })
    $dragButton.append($dragButtonImage)
    $span = $('<span>', { text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit' })
    $buttons = $('<div>', { class: 'content-editor__section-buttons' })
    $lock = $('<span>', { class: 'content-editor__section-button lock-button' })
    $display = $('<span>', { class: 'content-editor__section-button display-button' })
    $delete = $('<span>', { class: 'content-editor__section-button delete-button' })
    $lockImage = $('<img />', { src: 'img/icons/lock.svg' })
    $displayImage = $('<img />', { src: 'img/icons/eye.svg' })
    $deleteImage = $('<img />', { src: 'img/icons/x.svg' })
    $($li).append($header).append($dragButton).append($span).append($buttons)
    $($buttons).append($lock).append($display).append($delete)
    
    $menuItem = $('<a>', { class: 'aside-card__section-item', href: '#' })
    $menuItemNumber = $('<span>', { class: 'aside-card__section-number', text: $number })
    $menuItemName = $('<span>', { class: 'aside-card__section-name', text: 'Text section' })
    $menuItemButtons = $('<span>', { class: 'aside-card__section-buttons' })
    $menuLock = $('<span>', { class: 'aside-card__section-lock lock-button' })
    $menuDisplay = $('<span>', { class: 'aside-card__section-lock display-button' })
    $menuDelete = $('<span>', { class: 'aside-card__section-lock delete-button' })
    $menuLockImage = $('<img />', { src: 'img/icons/lock.svg' })
    $menuDisplayImage = $('<img />', { src: 'img/icons/eye.svg' })
    $menuDeleteImage = $('<img />', { src: 'img/icons/x.svg' })
    
    $($menuItemButtons).append($menuLock).append($menuDisplay).append($menuDelete)
    $menuItem.append($menuItemNumber).append($menuItemName).append($menuItemButtons)
    
    $('ul#sortable').append($li)
    $('.aside-card__info--section-list').append($menuItem)
    $($lockImage).appendTo($($lock))
    $($displayImage).appendTo($($display))
    $($deleteImage).appendTo($($delete))
    $($menuLockImage).appendTo($($menuLock))
    $($menuDisplayImage).appendTo($($menuDelete))
    $($menuDeleteImage).appendTo($($menuDelete))
  })
  
  $(document).on('click', '.new-sections-buttons .control-buttons .image-button', function() {
    $order = $('.content-editor__section').length + 1
    $number = $order > 9 ? $order.toString() : '0' + $order.toString()
    $li = $('<li>', { class: 'content-editor__section content-editor__section--image' })
    $header = $('<h4>', { class: 'content-editor__section-title' })
    $sectionNumber = $('<span>', { class: 'content-editor__section-number', text: $number })
    ...
    $dragButtonImage = $('<img />', { src: 'img/dragdrop.svg', alt: 'DragDropBtn' })
    $dragButton.append($dragButtonImage)
    $image = $('<img />', { src: 'img/samplepic.png', alt: 'Pic' })
    $buttons = $('<div>', { class: 'content-editor__section-buttons' })
    $lock = $('<div>', { class: 'content-editor__section-button lock-button' })
    $display = $('<div>', { class: 'content-editor__section-button display-button' })
    $delete = $('<div>', { class: 'content-editor__section-button delete-button' })
    $lockImage = $('<img />', { src: 'img/icons/lock.svg' })
    $displayImage = $('<img />', { src: 'img/icons/eye.svg' })
    $deleteImage = $('<img />', { src: 'img/icons/x.svg' })
  
    $($li).append($header).append($dragButton).append($image).append($buttons)
    $($buttons).append($lock).append($display).append($delete)
  
    $menuItem = $('<a>', { class: 'aside-card__section-item', href: '#' })
    $menuItemNumber = $('<span>', { class: 'aside-card__section-number', text: $number })
    $menuItemName = $('<span>', { class: 'aside-card__section-name', text: 'Image section' })
    $menuItemButtons = $('<span>', { class: 'aside-card__section-buttons' })
    $menuLock = $('<div>', { class: 'aside-card__section-lock lock-button' })
    $menuDisplay = $('<div>', { class: 'aside-card__section-lock display-button' })
    $menuDelete = $('<div>', { class: 'aside-card__section-lock delete-button' })
    $menuLockImage = $('<img />', { src: 'img/icons/lock.svg' })
    $menuDisplayImage = $('<img />', { src: 'img/icons/eye.svg' })
    $menuDeleteImage = $('<img />', { src: 'img/icons/x.svg' })
    $menuItemButtons.append($menuLock).append($menuDisplay).append($menuDelete)
  ...
  $(document).on('click', '.new-sections-buttons .control-buttons .code-button', function() {
    $order = $('.content-editor__section').length + 1
    $number = $order > 9 ? $order.toString() : '0' + $order.toString()
    $li = $('<li>', { class: 'content-editor__section content-editor__section--html' })
    $header = $('<h4>', { class: 'content-editor__section-title' })
    $sectionNumber = $('<span>', { class: 'content-editor__section-number', text: $number })
    $header.text('HTML section')
    $header.prepend($sectionNumber)
    $dragButton = $('<div>', { class: 'content-editor__dragdrop-btn' })
    $dragButtonImage = $('<img />', { src: 'img/dragdrop.svg', alt: 'DragDropBtn' })
    $dragButton.append($dragButtonImage)
    $form = $('<form>', { class: 'codemirror-editor' })
    $textarea = $('<textarea>', { id: 'codemirror-editor_textarea' })
    ...
    $deleteImage = $('<img />', { src: 'img/icons/x.svg' })
    $($buttons).append($lock).append($display).append($delete)
    $($li).append($header).append($dragButton).append($form).append($buttons)
  
    $menuItem = $('<a>', { class: 'aside-card__section-item', href: '#' })
    $menuItemNumber = $('<span>', { class: 'aside-card__section-number', text: $number })
    $menuItemName = $('<span>', { class: 'aside-card__section-name', text: 'HTML section' })
    $menuItemButtons = $('<span>', { class: 'aside-card__section-buttons' })
    $menuLock = $('<div>', { class: 'aside-card__section-lock lock-button' })
    $menuDisplay = $('<div>', { class: 'aside-card__section-lock display-button' })
    $menuDelete = $('<div>', { class: 'aside-card__section-lock delete-button' })
  ...
  $('.new-sections-buttons .main').click(function() {
  if ($('.new-sections-buttons .control-buttons').css('display') == 'none') {
    $('.new-sections-buttons .control-buttons').css('display', 'block')
  } else {
    $('.new-sections-buttons .control-buttons').css('display', 'none')    
  }
  })
})
...
function() {
	if ($('input.custom-checkbox-input').is(':checked')) {
		$('.action-menu').addClass('fade-forwards');
		$('.action-menu').removeClass('fade-backwards');
		$('.navbar').removeClass('navbar-shadow');
		$('.custom-card-section').addClass('margin-change-forwards');
 		$('.custom-card-section').removeClass('margin-change-backwards');
	}
	else {
		$('.action-menu').removeClass('fade-forwards');
		$('.action-menu').addClass('fade-backwards');
		$('.navbar').addClass('navbar-shadow');
		$('.custom-card-section').addClass('margin-change-backwards');
 		$('.custom-card-section').removeClass('margin-change-forwards');
	}
});
// To show/hide an action menu --- end


// Ta disable checking multiple checkboxes in a table --- start
$('input.custom-checkbox-input').on('change', function() {
    $('input.custom-checkbox-input').not(this).prop('checked', false);  
});
// Ta disable checking multiple checkboxes in a table --- end


// To initialise a DataTable plugin for a table --- start
$(document).ready(function() {
    $('#example').DataTable( {
        "paging":   false,
        "info":     false,
...
// To initialise a DataTable plugin for a table --- end


// To show/hide a filter/view/sort/more/user dropdown --- start
$('#filter-link').on('click', function (event) {
	$('.dropdown-menu-filter').toggle('blind', 200);
	$('.dropdown-menu-filter').toggleClass('visible-test');
});

$('#view-link').on('click', function (event) {
	$('.dropdown-menu-view').toggle('blind', 200);
	$('.dropdown-menu-view').toggleClass('visible-test');
});

$('#sort-link').on('click', function (event) {
	$('.dropdown-menu-sort').toggle('blind', 200);
	$('.dropdown-menu-sort').toggleClass('visible-test');
});

$('#more-link').on('click', function (event) {
	$('.dropdown-menu-more').toggle('blind', 200);
	$('.dropdown-menu-more').toggleClass('visible-test');
});

$('#user-link').on('click', function (event) {
	$('.dropdown-menu-user').toggle('blind', 200);
	$('.dropdown-menu-user').toggleClass('visible-test');
});
// To show/hide a filter/view/sort/more/user dropdown --- end


// To hide dropdowns by clicking outside and keep it open if clicked on the element inside --- start
$(document).on("click", function(e) {
	if ($(e.target).is('.visible-test, .dropdown-menu-filter, #filter-link, #filter-link>.feather, #filter-link>span, #filter-link>svg>use') === false
		&& $('.dropdown-menu-filter, .dropdown-menu-filter.visible-test').has(e.target).length === 0
	) {
	  $('.dropdown-menu-filter').removeClass('visible-test');
	  $('.dropdown-menu-filter').hide('fade', 200);
	}
});

$(document).on("click", function(e) {
	if ($(e.target).is('.dropdown-menu-view, #view-link, #view-link>.feather, #view-link>span, #view-link>svg>use') === false
		&& $('.dropdown-menu-view, .dropdown-menu-view.show-forwards').has(e.target).length === 0
	) {
	  $('.dropdown-menu-view').removeClass('visible-test');
	  $('.dropdown-menu-view').hide('fade', 200);
	}
});

$(document).on("click", function(e) {
	if ($(e.target).is('.visible-test, .dropdown-menu-sort, #sort-link, #sort-link>.feather, #sort-link>span, #sort-link>svg>use') === false
		&& $('.dropdown-menu-sort, .dropdown-menu-sort.visible-test').has(e.target).length === 0
	) {
	  $('.dropdown-menu-sort').removeClass('visible-test');
	  $('.dropdown-menu-sort').hide('fade', 200);
	}
});

$(document).on("click", function(e) {
	if ($(e.target).is('.visible-test, .dropdown-menu-more, #more-link, #more-link>.feather, #more-link>span, #more-link>svg>use') === false
		&& $('.dropdown-menu-more, .dropdown-menu-more.visible-test').has(e.target).length === 0
	) {
	  $('.dropdown-menu-more').removeClass('visible-test');
	  $('.dropdown-menu-more').hide('fade', 200);
	}
});

$(document).on("click", function(e) {
	if ($(e.target).is('.visible-test, .dropdown-menu-user, #user-link, #user-link>.feather, #user-link>span, #user-link>svg>use, #user-link>img') === false
		&& $('.dropdown-menu-user, .dropdown-menu-user.visible-test').has(e.target).length === 0
	) {
	  $('.dropdown-menu-user').removeClass('visible-test');
	  $('.dropdown-menu-user').hide('fade', 200);
	}
});
// To hide dropdowns by clicking outside and keep it open if clicked on the element inside --- end
 

// Rename view, save the new name by clicking outside, save the new name by pressing ENTER --- start
$('#rename-view-btn').click(function(){
	$('#view-title').hide();
	$('.view-input').show();
	$('.view-input').select();
...
$('.view-input').blur(function() {
	if ($.trim(this.value) == ''){
		...
		$('#view-title').html(this.value);
		$('#view-sub-title').html(this.value);
	}
	$('.view-input').hide();
	$('#view-title').show();
});

$('.view-input').keypress(function(event) {
  if (event.keyCode == '13') {
	  if ($.trim(this.value) == ''){
		 this.value = (this.defaultValue ? this.defaultValue : '');
	 }
...
// Rename view, save the new name by clicking outside, save the new name by pressing ENTER --- end
...
// Custom context menus for each page --- start
// $(function() {
// 	$.contextMenu({
// 		selector: 'tr.landers-tr', 
// 		className: 'landers-tr__context-menu',
// 		items: {
// 			"View field": {name: "View"},
// 			"Edit field": {name: "Edit"},
// 			"CK field": {name: "CK"},
// 			"Copy field": {name: "Copy"},
// 			"Delete field": {name: "Delete"},
// 			"Deploy field": {name: "Deploy"},
//     	}
//   	});
// });
...
$(function() {
	$.contextMenu({
		selector: 'tr.blocks-tr', 
		className: 'blocks-tr__context-menu',
		items: {
			"View field": {name: "View"},
			"Edit field": {name: "Edit"},
			"Copy field": {name: "Copy"},
...
$(function() {
	$.contextMenu({
		selector: 'tr.templates-tr', 
		className: 'templates-tr__context-menu',
		items: {
			"View field": {name: "View"},
			"Edit field": {name: "Edit"},
			"Copy field": {name: "Copy"},
...
$(function() {
	$.contextMenu({
		selector: 'tr.content-tr', 
		className: 'content-tr__context-menu',
		items: {
			"View field": {name: "View"},
			"Edit field": {name: "Edit"},
			"Copy field": {name: "Copy"},
			"Delete field": {name: "Delete"},
			"Create lander": {name: "Create lander"}
    	},
    	callback: function(key, options) {
	      if (key === "Edit field") {
	        window.location.href = "editor.html";
...
// Custom context menus for each page --- end
